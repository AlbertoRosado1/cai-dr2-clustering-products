...
def test_window_fm(tracer='QSO'):
    ...
    options = {
        ...
        "mattrs": mattrs,
        "mesh2_spectrum": {"optimal_weights": None},  # functools.partial(tools.compute_fiducial_png_weights, tracer=tracer)},
        ...
        "window_mesh2_spectrum_fm": {
            ...
            "seeds": [42],  # , 84],
            # "theory_rebin": 1,
            "optimal_weights": None,  # functools.partial(tools.compute_fiducial_png_weights, tracer=tracer),
            "ric": False,
            "amr": False,
        },
    }
