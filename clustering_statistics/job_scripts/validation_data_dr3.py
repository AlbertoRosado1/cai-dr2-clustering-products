...
python job_scripts/desipipe_data_dr3.py
desipipe tasks -q data_dr3  # check the list of tasks
desipipe spawn -q data_dr3 --spawn  # spawn the jobs
desipipe queues -q data_dr3  # check the queue
Or directly if mode = 'interactive':
salloc -N 1 -C "gpu&hbm80g" -t 02:00:00 --gpus 4 --qos interactive --account desi_g
srun -n 4 python job_scripts/desipipe_data_dr3.py
"""
...
# Create a job queue named 'data_dr3' for managing computation tasks
queue = Queue('data_dr3')
...
output, error = './slurm_outputs/data_dr3/slurm-%j.out', './slurm_outputs/data_dr3/slurm-%j.err'
kwargs = {}
